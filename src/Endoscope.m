classdef Endoscope < Robot
    % ENDOSCOPE This class encapsulates the design parameters of the
    % endocsope, which containts both the chip-tip camera and wrist.
    % Assumes endoscope bends with constant curvature
    %
    %   Author: Jesse F d'Almeida <jfdalmeida@wpi.edu>
    %
    %   Last revision: 05/29/2020
