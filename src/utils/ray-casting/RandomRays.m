function r = RandomRays(coneAngleDegree, coneDir, N)
%   RANDOMRAYS create list of rays within a spherical cap
%   
%   Output:
%       r - [3xN] random points on a spherical cap
%
%   Inputs:
%       coneAngleDegree - (deg) conical angle
%       coneDir         - [3x1] center of cone
%       N               - number of points
%
%   Authors: Ahmed Fasih
